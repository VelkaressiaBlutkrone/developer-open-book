...
![로컬 저장이 필요한 시나리오](/developer-open-book/diagrams/flutter-step18-local-storage-scenarios.svg)

### 1.2 로컬 저장소 종류 한눈에 보기

![저장소 선택 가이드](/developer-open-book/diagrams/flutter-step18-storage-selection.svg)
...
![Firestore 온라인 오프라인 동작](/developer-open-book/diagrams/flutter-step18-firestore-offline.svg)
