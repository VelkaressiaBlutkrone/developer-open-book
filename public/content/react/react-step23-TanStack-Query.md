...
![Step 22의 한계              TanStack Query의 해결](/developer-open-book/diagrams/react-step23-step-22의-한계-tanstack-query의-해결.svg)
...
![다루는 것](/developer-open-book/diagrams/react-step23-다루는-것.svg)
...
![TanStack Query 아키텍처](/developer-open-book/diagrams/react-step23-tanstack-query-아키텍처.svg)
...
![isLoading vs isFetching — 미묘하지만 중요한 차이](/developer-open-book/diagrams/react-step23-isloading-vs-isfetching-미묘하지만-중요한-차이.svg)
...
![queryKey는 캐싱, 리패칭, 공유, 무효화의 기준이 된다](/developer-open-book/diagrams/react-step23-querykey는-캐싱-리패칭-공유-무효화의-기준이-된다.svg)
...
![데이터의 생명주기 (시간 흐름)](/developer-open-book/diagrams/react-step23-데이터의-생명주기-시간-흐름.svg)


#### 자동 리패칭 트리거


![캐시가 stale 상태일 때, 다음 상황에서 자동 리패칭:](/developer-open-book/diagrams/react-step23-캐시가-stale-상태일-때-다음-상황에서-자동-리패칭.svg)


#### staleTime 설정 가이드


![데이터 유형별 권장 staleTime](/developer-open-book/diagrams/react-step23-데이터-유형별-권장-staletime.svg)
...
![Optimistic Update 흐름](/developer-open-book/diagrams/react-step23-optimistic-update-흐름.svg)
...
![수동 패칭의 한계           TanStack Query의 해결](/developer-open-book/diagrams/react-step23-수동-패칭의-한계-tanstack-query의-해결.svg)
...
![이 설계의 이점](/developer-open-book/diagrams/react-step23-이-설계의-이점.svg)
...
![요구사항:](/developer-open-book/diagrams/react-step23-요구사항.svg)
...
![요구사항:](/developer-open-book/diagrams/react-step23-요구사항-13.svg)
...
![요구사항:](/developer-open-book/diagrams/react-step23-요구사항-14.svg)
...
![Step 23 핵심 요약](/developer-open-book/diagrams/react-step23-step-23-핵심-요약.svg)
