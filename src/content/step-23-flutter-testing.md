...
![테스트 없는 개발의 비용](/developer-open-book/diagrams/flutter-step23-cost-without-test.svg)
...
![FIRST 테스트 원칙](/developer-open-book/diagrams/flutter-step23-first-principles.svg)
...
![TDD 사이클](/developer-open-book/diagrams/flutter-step23-tdd-cycle.svg)

---

### 4.2 테스트 커버리지 목표 설정

![계층별 커버리지 권장 목표](/developer-open-book/diagrams/flutter-step23-coverage-targets.svg)
