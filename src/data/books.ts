...
export const BOOKS: Book[] = [
  ...
  // ── Flutter ──
  { id: 'flutter-roadmap', title: 'Flutter 학습 로드맵', step: 'Overview', category: 'flutter', contentFile: `${BASE}content/flutter/flutter.md` },
  { id: 'flutter-01', title: 'Flutter 아키텍처', step: 'Step 01', category: 'flutter', contentFile: `${BASE}content/flutter/step-01-flutter.md` },
  { id: 'flutter-02', title: 'Dart 언어 핵심', step: 'Step 02', category: 'flutter', contentFile: `${BASE}content/flutter/step-02-dart.md` },
  { id: 'flutter-03', title: 'Flutter 개발 환경', step: 'Step 03', category: 'flutter', contentFile: `${BASE}content/flutter/step-03-flutter.md` },
  { id: 'flutter-04', title: 'Widget 개념', step: 'Step 04', category: 'flutter', contentFile: `${BASE}content/flutter/step-04-widget.md` },
  { id: 'flutter-05', title: 'Stateless vs Stateful', step: 'Step 05', category: 'flutter', contentFile: `${BASE}content/flutter/step-05-statelesswidget-vs-statefulwidget.md` },
  { id: 'flutter-06', title: 'Layout 시스템', step: 'Step 06', category: 'flutter', contentFile: `${BASE}content/flutter/step-06-layout.md` },
  { id: 'flutter-07', title: '기본 UI 위젯', step: 'Step 07', category: 'flutter', contentFile: `${BASE}content/flutter/step-07-ui.md` },
  { id: 'flutter-08', title: 'Material Design', step: 'Step 08', category: 'flutter', contentFile: `${BASE}content/flutter/step-08-material-design.md` },
  { id: 'flutter-09', title: '사용자 입력 처리', step: 'Step 09', category: 'flutter', contentFile: `${BASE}content/flutter/step-09.md` },
  { id: 'flutter-10', title: 'Form 시스템', step: 'Step 10', category: 'flutter', contentFile: `${BASE}content/flutter/step-10-form.md` },
  { id: 'flutter-11', title: 'Navigation 시스템', step: 'Step 11', category: 'flutter', contentFile: `${BASE}content/flutter/step-11-navigation.md` },
  { id: 'flutter-12', title: '상태관리 개념', step: 'Step 12', category: 'flutter', contentFile: `${BASE}content/flutter/step-12-flutter.md` },
  { id: 'flutter-13', title: 'setState', step: 'Step 13', category: 'flutter', contentFile: `${BASE}content/flutter/step-13-setstate.md` },
  { id: 'flutter-14', title: 'Provider 패턴', step: 'Step 14', category: 'flutter', contentFile: `${BASE}content/flutter/step-14-provider.md` },
  { id: 'flutter-15', title: '고급 상태관리', step: 'Step 15', category: 'flutter', contentFile: `${BASE}content/flutter/step-15.md` },
  { id: 'flutter-16', title: 'Future / Async UI', step: 'Step 16', category: 'flutter', contentFile: `${BASE}content/flutter/step-16-future-async-ui.md` },
  { id: 'flutter-17', title: 'HTTP 통신', step: 'Step 17', category: 'flutter', contentFile: `${BASE}content/flutter/step-17-http.md` },
  { id: 'flutter-18', title: '로컬 데이터 저장', step: 'Step 18', category: 'flutter', contentFile: `${BASE}content/flutter/step-18.md` },
  { id: 'flutter-19', title: 'Animation', step: 'Step 19', category: 'flutter', contentFile: `${BASE}content/flutter/step-19-animation.md` },
  { id: 'flutter-20', title: 'Project Structure', step: 'Step 20', category: 'flutter', contentFile: `${BASE}content/flutter/step-20-flutter-project-structure.md` },
  { id: 'flutter-21', title: 'Clean Architecture', step: 'Step 21', category: 'flutter', contentFile: `${BASE}content/flutter/step-21-clean-architecture.md` },
  { id: 'flutter-22', title: 'Dependency Injection', step: 'Step 22', category: 'flutter', contentFile: `${BASE}content/flutter/step-22-dependency-injection.md` },
  { id: 'flutter-23', title: 'Testing', step: 'Step 23', category: 'flutter', contentFile: `${BASE}content/flutter/step-23-flutter-testing.md` },
  { id: 'flutter-24', title: 'Rendering Optimization', step: 'Step 24', category: 'flutter', contentFile: `${BASE}content/flutter/step-24-flutter-rendering-optimization.md` },
  { id: 'flutter-25', title: 'Memory Management', step: 'Step 25', category: 'flutter', contentFile: `${BASE}content/flutter/step-25-memory-management.md` },
  { id: 'flutter-26', title: 'Native Integration', step: 'Step 26', category: 'flutter', contentFile: `${BASE}content/flutter/step-26-native-integration.md` },
  { id: 'flutter-27', title: 'AI Integration', step: 'Step 27', category: 'flutter', contentFile: `${BASE}content/flutter/step-27-ai-integration.md` },
  { id: 'flutter-28', title: 'Push Notifications', step: 'Step 28', category: 'flutter', contentFile: `${BASE}content/flutter/step-28-push-notifications.md` },
  { id: 'flutter-29', title: 'App Build & Deploy', step: 'Step 29', category: 'flutter', contentFile: `${BASE}content/flutter/step-29-app-build-deploy.md` },
  { id: 'flutter-30', title: 'CI/CD', step: 'Step 30', category: 'flutter', contentFile: `${BASE}content/flutter/step-30-cicd.md` },
